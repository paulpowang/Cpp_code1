...
int main()
{
    ...
    cout<< "default Single Linked List: "<< list1;
    cout<<endl;
    int x=0;
    while(x!=-1){
    ...
    if(x == 1)
    {
      ...
      cout << endl;
      cout << "Enter double number for pushFront or -1 to exit: ";
      while(input1!=-1)
      {
        cin >> input1;
        if(input1!=-1)
    ...
    else if (x ==2)
    {
      ...
      cout <<"Current list: "<<list1;
      cout << endl;
      cout << "Enter double number for pushBack or -1 to exit: ";
      while(input2!=-1)
      {
        cin >> input2;
        if(input2!=-1)
    ...
    else if (x ==6)
    {
      ...
      cout <<"Current list: "<<list1;
      cout << endl << "Enter 1 double number for deleteDuplicates: ";
      double input6;
      cin >> input6;
